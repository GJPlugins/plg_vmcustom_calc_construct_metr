...
<div class="gtm-picker__row blg-really-comfortable"
     ...
     data-evt-action-click-id="<?= $type_property_id ?>"



     data-ng-click="$ctrl.selectType(template)"
     role="button">
    <div class="column-row-icon no-border blue">
        <gtm-vt-icon template="template">
            <!---->
    ...
    <div class="blg-body-and-caption">
        <div ng-bind-html="::$ctrl.getDisplayName(template)"><?= $title ?></div>
        <div  ><?= $caption ?></div>
    </div>
