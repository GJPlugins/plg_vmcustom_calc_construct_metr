...
<div data-ng-form="ctrl.form"
     ...
     class="gtm-veditor-section ng-pristine ng-valid ng-valid-integer gtm-read-only veditor__section--read-only gtm-veditor-editable"
     role="button">
    <input type="hidden" name="type_property_id" value="<?= $type_property_id ?>">
