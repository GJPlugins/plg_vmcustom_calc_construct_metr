<?php
    ...
    JLoader::register('GtmFormField' , JPATH_PLUGINS.'/system/plg_vmcustom_calc_construct_metr/models/fields/GtmFormField.php');
     ...
     * @since  1.7.0
     */
    class GtmFormFieldCheckbox extends \GtmFormField
    {

        /**
         * Layout to render the form field GTM
         *
         * @var  string
         * @since 3.9
         */
        protected $renderLayout = 'renderfieldCheckbox';
