...
<div class="gtm-root" data-ng-include="'/gtm/app/app.html'">
    <div data-ng-controller="ApplicationController as ctrl" class="gtm-page"
        ...
        <div class="gms-top-nav org-loaded" id="suite-top-nav">
            <!---->
            <?php echo $this->loadTemplate('suite-header'); ?>
            <!---->
                    ...
                    <div data-gtm-page-tracker="">
                        ...
                        <div class="gtm-container-page">
                            <div class="gtm-container-page-navigation">
                                <?php
                                    echo $this->loadTemplate('gtm-container-menu');
//                                    echo $this->sublayout('gtm-container-menu' , $displayData); ?>
                            </div>
                                        ...
                                        <div class="gtm-table-component gtm-table-component--single-page gtm-table-component--has-items"
                                            ...
                                            <div class="card-title-bar">
                                                ...
                                                <div class="card-actions" >
                                                    <!---->
                                                    <!--Фильтр по таблице-->
                                                    <?php //echo $this->sublayout('gtm-table-filter' , $displayData); ?>
                                                    <!---->
                                                    <!---->

                                                    <?= $this->loadTemplate('gtm-actions-table') ?>
                                                    <!---->

                                                    <!-- Кнопка создать свойство товара -->
                                                    <button class="btn btn--create wd-create-tag-btn"
                                                            onclick="vmccm.SheetController.loadSheet( 'product_property' )">
                                                        Создать
                                                    </button>
                                                    <!---->
                                            ...
                                            <?php
                                                echo $this->loadTemplate('gtm-root-sheet-table');

//                                                echo $this->sublayout('gtm-root-sheet-table' , $displayData); ?>
                                            <!-- gtm-pagination -->
                                            <?php
                                                echo $this->loadTemplate('gtm-pagination');
//                                                echo $this->sublayout('gtm-pagination' , $displayData); ?>
