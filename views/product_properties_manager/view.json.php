...
class vccmViewproduct_properties_manager extends \Joomla\CMS\MVC\View\HtmlView{
    ...
    public function display( $tpl = null)
    {
        ...
        $Model = $this->getModel();
        $this->DataTable = $Model->getListProductPropertyConfig();
       ...
       //
         ...
         */
        $_tmpl_setting = $HelperTemplateForm->getTemplate( 'listProperties' , $params );
